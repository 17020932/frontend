      ...
      <div className="col-xl-8 col-lg-7">
        <div className="card shadow mb-4">
          ...
          <div className="card-body  d-flex align-items-center" >
            <div className="chart-area" style={{margin: '0 auto'}}>
      ...
      <div className="col-xl-4 col-lg-5">
        <div className="card shadow mb-4">
          ...
          <div>
            ...
            <div className="card-body d-flex align-items-center" style={{margin: '0 auto'}}>
              {/* đổ biểu đồ tròn vào trong thẻ canvas */}
              <PieChart  onMouseEnter={this.onPieEnter} width={300} height={245}>
                <Pie
                style={{animation: 'chartjs-render-animation 1ms'}}
                  data={this.state.data}
                  cx={145}
                  cy={90}
                  innerRadius={70}
                  ...
                  >
                    <thead>
                      <tr role="row">
                        ...
                        <th tabIndex={0} rowSpan={1} colSpan={1} className="text-center">
                          Người làm bài
                    ...
                    <tbody>
                      ...
                      <tr role="row" className="even">
                        ...
                        <td className="text-center">Chief Executive Officer (CEO)</td>
                        <td className="text-center">10</td>
                        <td className="text-center">47</td>
                      </tr>
                      <tr role="row" className="odd">
                        <td className="sorting_1 text-center">3</td>
                        <td className="text-center">Junior Technical Author</td>
                        <td className="text-center">10</td>
